...
export const servicePages: Record<string, { title: string; paragraphs: string[] }> = {
  ...
  "/cookies": { title: "Cookies & browser storage", paragraphs: [
    ...
    "Google sign-in and Razorpay checkout are separate provider services and may use their own storage. Any future optional analytics or marketing integration must be reviewed and gated before loading; this page alone does not block third-party tracking.",
  ] },
